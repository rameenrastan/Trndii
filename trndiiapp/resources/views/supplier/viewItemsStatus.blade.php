                                        ...
                                        <div style="border: 3px solid #ccfff0;">
                                            ...
                                            <div class="display-group">
                                                <div><p align="left" style="padding-left:10px">Status:
                                                        <b>{{$supplierItem->Status}}</b></p></div>
                                            </div>
                                            <div class="display-group">
                                                <div><p align="left" style="padding-left:10px">Sale ends
                                                        <b>{{\Carbon\Carbon::parse($supplierItem->End_Date)->format('d/m/Y')}}</b>
                                                    </p></div>
                                            </div>
                                            <div class="progress" style="margin: 20px;">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="70"
                                                     aria-valuemin="0" aria-valuemax="100"
                                                     style="width:{{$supplierItem->Number_Transactions/$supplierItem->Threshold*100}}%; background-color: #14A989;">
                                                </div>
                                            </div>
                                            <div class="row" style="font-size: 16px;">
                                                <div class="col-md-12 text-center">
                                                    {{$supplierItem->Number_Transactions}}
                                                    / {{$supplierItem->Threshold}} Orders Placed <br><br>
                                                </div>
                                            </div>
                                            <div class="display-group">
                                                ...
                                                <div class="display-group">
                                                    <div>
                                                        <p align="center" style="padding-left:10px">
                                                            <button type="button">Obtain Addresses</button>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
